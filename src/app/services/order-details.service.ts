...
export class OrderDetailsService {
  ...
  foodDetails=[
    ...
    {id:3, image:"../../../assets/food.jpg" ,name:"blah blah",price:"$5",details:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s"},
